...
jump_fx = pygame.mixer.Sound(resource_path('.\\audio\\jump4.mp3'))
jump_fx.set_volume(0.05)
shot_fx = pygame.mixer.Sound(resource_path('.\\audio\\shot3.mp3'))
shot_fx.set_volume(0.05)
grenade_fx = pygame.mixer.Sound(resource_path('.\\audio\\grenade2.mp3'))
...
#define font
font = pygame.font.SysFont('Futura', 30) # Futura
...
class Soldier(pygame.sprite.Sprite):
	def __init__(self, char_type, x, y, scale, speed, ammo, grenades):
		...
		for animation in animation_types:
			...
			num_of_frames = len(os.listdir(resource_path(f'.\\img\\{self.char_type}\\{animation}')))
			for i in range(num_of_frames):
				img = pygame.image.load(resource_path(f'.\\img\\{self.char_type}\\{animation}\\{i}.png')).convert_alpha()
...
with open(resource_path(f'.\\level{level}_data.csv'), newline='') as csvfile:
